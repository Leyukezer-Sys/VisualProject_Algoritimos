...
namespace Exercicios
{
    internal class Capitulo7
    {
        ...
        public void Exercicio2()
        {
             ...
             */
            string continua = "";
            int[] vetorA, vetorPar, vetorCinco;
            ...
            do
            {
                ...
                do
                {
                    ...
                    if (op == 1)
                    {
                        contPar = bb.ContadorMatrizMultiploN(vetorA, 2);
                        vetorPar = bb.GerarMatrizMultiploN(vetorA, contPar, 2);
                        Console.Write("\nMatriz Numeros Pares: ");
                        resp = "";
                        foreach (int item in vetorPar)
                        {
                            resp += $"|{item}";
                        }
                        resp += "|\n";
                    ...
                    if (op == 2)
                    {
                        contCinco = bb.ContadorMatrizMultiploN(vetorA, 5);
                        vetorCinco = bb.GerarMatrizMultiploN(vetorA, contCinco, 5);
                        Console.Write("\nMatriz Multiplos de 5: ");
                        resp = "";
                        foreach (int item in vetorCinco)
                        {
                            resp += $"|{item}";
                        }
                        resp += "|\n";
                    ...
                    if (op == 3)
                    {
                        vetorA = bb.OrdernarVetor(vetorA); ;
                        Console.Write("\nMatriz Ordenada: ");
                        resp = "";
